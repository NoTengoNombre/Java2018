 ...
 */
package dawsevilla.t4ManejoFlujoDatos.estructuras.condicionales.asimples;
...
public class P8SentenciasCondicionales {
 ...
 public static void main(String[] args) {
  ...
  P8SentenciasCondicionales valores = new P8SentenciasCondicionales();

  // Declaracion e inicialización de variables
  int num_aciertos = valores.getValores();
  int num_errores = valores.getValores();
